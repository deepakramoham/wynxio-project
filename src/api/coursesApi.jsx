...
export const postCourseData = async (dispatch, courseData) => {
  try {
...
export const updateCourseData = async (dispatch, courseData) => {
  try {
...
export const deleteCourseData = async (dispatch, id) => {
  try {
